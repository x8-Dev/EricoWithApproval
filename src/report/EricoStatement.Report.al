report 70100 EricoStatement
{
    // Copied from report 116: "Statement"
    DefaultLayout = RDLC;
    RDLCLayout = 'src\report\layout\EricoStatement.rdlc';
    Caption = 'Statement';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(IsLineHighLighted; IsLineHighLighted)
                            {
                            }
                            ...
                            begin
                                ...
                                if (CustLedgerEntry."Due Date" >= StartDate) and (CustLedgerEntry."Due Date" <= EndDate) then begin
                    ...
                    dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                    {
                        ...
                        begin
                            if (CustLedgEntry2."Due Date" >= StartDate) and (CustLedgEntry2."Due Date" <= EndDate) then begin
                    ...
                    begin
                        ...
                        repeat
                            ...
                            CustLedgerEntry.SetRange("Due Date", StartDate, EndDate);
                        ...
                        CustLedgerEntry2.SetRange("Due Date", StartDate, EndDate);
                        CustLedgerEntry2.SetRange("Currency Code", TempCurrency2.Code);
                        if CustLedgEntry2.FindFirst() then begin
                            ...
                            DetailedLedgerEntries.SetRange("Customer No.", Cust2."No.");
                            DetailedLedgerEntries.SetRange("Initial Entry Due Date", 0D, StartDate);
                            DetailedLedgerEntries.SetRange("Initial Entry Global Dim. 1", Cust2."Global Dimension 1 Code");
                            DetailedLedgerEntries.SetRange("Initial Entry Global Dim. 2", Cust2."Global Dimension 2 Code");
                            DetailedLedgerEntries.SetRange("Currency Code", TempCurrency2.Code);
                            DetailedLedgerEntries.CalcSums(Amount);
                            StartBalance := DetailedLedgerEntries.Amount;
                            CustBalance := DetailedLedgerEntries.Amount;
                        end else begin
                            CurrReport.Skip();
                        end;
                    end;
            ...
            begin
                ...
                CurrReport.FormatRegion := Languages.GetFormatRegionOrDefault("Format Region");
